...
; Source: https://github.com/Descolada/AHK-v2-libraries/blob/main/Lib/WinEvent.ahk
; Ref: https://www.autohotkey.com/boards/viewtopic.php?f=83&t=126932
...
class WinEvent {
    ...
    class Hook {
        ...
        __Delete() {
            ...
            SetTimer(CallbackFree.Bind(this.pCallback), -60000) ; This needs to be done with a latency to let the message queue empty of unfired events
        }
    }
